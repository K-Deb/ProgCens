#' Simulating a progressively type-II censored sample from a univariate distribution
#'
...
#'
#' @return A dataframe with progressively type-II censored sample from a univariate distribution and the censoring scheme
#' @export
#' @examples
rpc2 = function(n, m = NULL, R = NULL, prob = NULL, QF, ..., set_seed = NULL)
{
